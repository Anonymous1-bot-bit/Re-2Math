    ...
    return {
        "meta": {
            ...
            "notes": [
                ...
                "Appendix stratified-table paper counts preserve raw stored paper_id values from the evaluation artifacts; high-level release docs use version-normalized paper counts.",
