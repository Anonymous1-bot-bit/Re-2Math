...
* **Tool Extraction Rules**:
    1.  **External Citation**: The proof relies on a result that is **explicitly cited** in the bibliography.
        * *ID:* Resolve to **arXiv ID** or **Author-Year** (e.g., "Chen et al. (2023)"). Do NOT use brackets like `[14]`.
        * *Statement:* Copy the formula *only if* written in the text. If the author just says "By [14]" without showing the formula, write `"NOT_STATED"`.
    2.  **Internal/Standard**: Any result used that is **NOT** an external citation. This includes:
        * Lemmas/Propositions proved in this paper.
        * Standard theorems (e.g., Young's, Hölder's, Gronwall's) applied directly.
        * Specific Equations (e.g., "From Eq. 5").
        * *Action:* Extract the **Name/Number** (e.g., "Lemma 3.2", "Young's Inequality") and the **Full LaTeX Statement**.
    ...
    "step_details": [
      {
        ...
        "key_tools": [
          ...
          },
          {
            ...
            "citation_id": "String (Lemma X / Eq Y / Tool Name)",
